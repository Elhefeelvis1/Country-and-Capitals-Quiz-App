...
//initializing player level and score
let level = 0;
let scoreNum = 0;

submit.addEventListener('click', () => {
  let userAnswer = input.value.trim();
  if(userAnswer.toLowerCase() == countries[level].city.toLowerCase()){
    scoreNum++;
    answer.textContent = "Correct Answer👏"
  }else{
    answer.textContent = "Wrong Answer, the correct answer: " + countries[level].city;
  }
  ...
  level++;
  country.textContent = countries[level].country;
})
